...
```{r write-sorted-data, eval = FALSE}
...
saveRDS(realms_long, "HMEI-GDrive/data/sorted/realms_long.Rds")
```

```{r load-sorted-data}
merge_dat <- readRDS("HMEI-GDrive/data/sorted/merge_dat.Rds")
realms_long <- readRDS("HMEI-GDrive/data/sorted/realms_long.Rds")
```
...
glm_full_nes <- 
    glm(NES ~ className * Realms + className * Category + Realms * Category, 
        data = filter(realms_long, realm_endemic),
