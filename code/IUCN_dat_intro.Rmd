...
For nonbinary changes, the classes with the median cat_change below 0 are ray-finned fish, amphibians, and gastropoda. The remaining species have a median change above 0. However, it is notable that all species have an interquartile range that encompasses 0 except for cycadopsida and gastropoda. Birds, mammals, reptiles, and most plants have the median at the upper end of the IQR and above 0. 
