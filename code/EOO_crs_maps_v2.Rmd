...
trait_df <- 
  ...
  filter(!(is.na(EOO_NES)),
         !(is.na(diff_top25))) %>% 
  dplyr::select(scientificName, className,
                redlistCategory, areaAOH, 
                EOO_Category, Difference, EOO_NES, diff_top25)
...
ggsave(plot = map_CRS_realm_combi,
       filename = "/workdir/sr2352/HMEI-internship/data/figs/nes_map_realm.png",
...
ggsave(plot = map_CRS_ctry_combi,
       filename = "/workdir/sr2352/HMEI-internship/data/figs/nes_map_country.png",
       width = 7, height = 20, units = "cm", dpi = 800)
```
...
ggsave(plot = map_top25_realm_combi,
       filename = "/workdir/sr2352/HMEI-internship/data/figs/top25_map_realm.png",
       width = 7, height = 20, units = "cm", dpi = 800)
```
...
ggsave(plot = map_top25_ctry_combi,
       filename = "/workdir/sr2352/HMEI-internship/data/figs/top25_map_country.png",
       width = 7, height = 20, units = "cm", dpi = 800)
```
...
ggsave(plot = map_realm_combi,
       filename = "/workdir/sr2352/HMEI-internship/data/figs/map_realm_combi.png",
...
ggsave(plot = map_country_combi,
       filename = "/workdir/sr2352/HMEI-internship/data/figs/map_country_combi.png",
       width = 12, height = 14, units = "cm", dpi = 800)
```
