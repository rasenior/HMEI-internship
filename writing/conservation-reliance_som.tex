...
\caption{The total number of threatened species within each country classified as `No Exit Species' (NES). Results are summarised for each taxonomic group (rows), , and shaded from low NES count (yellow) to high (red).}\label{fig:fig-s-1}
\end{figure}
