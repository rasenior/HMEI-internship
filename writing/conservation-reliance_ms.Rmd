...
<!-- TI am leaving the general outline here because I mostly followed it (with a few small differences) -->
...
Biodiversity is the foundation of ecosystem survival, providing strength in genetic and species diversity, resilience to changes, and complex food systems. Biodiversity also provides benefits to agriculture [@CITE], human health, such as purification of air and water, and climate regulation [@CITE]. However, the world is currently experiencing a biodiversity crisis [@wwf_living_2020; @rosenberg_decline_2019], driven primarily by habitat loss. Across all anthropic changes on Earth, habitat conversion is the leading cause of species extinctions  [@maxwell_biodiversity:_2016;@goncalves-souzaHabitatLossExtinction2020]. This habitat conversion is largely due to agricultural expansion [@wwf_living_2020; @williams_proactive_2020; @gibbs_tropical_2010]. Furthermore, habitat loss is expected to continue to pose a major threat to biodiversity. As demand for food increases, driven by population growth and eating habits, the climate and agricultural sector is expected to grow and develop in tandem. Improvements in efficiency, such as increasing yields per area, decreasing waste, and shifting away from meat-based diets in some cultures [@tilman_global_2011; @tilman_future_2017; @williams_proactive_2020], could help to abate habitat loss for some threatened species, but many will face further conversion of primary habitat - particularly in the tropics [@gibbs_tropical_2010]. Because habitat destruction is one of the most influential factors in species extinction and will continue to be so into the future, preventing and managing habitat destruction is a central issue in conservation and ecology [@liaoModellingPlantPopulation2013]. Additionally, quantifying the amount of habitat a species occupies will also be extremely important in understanding the species’ extinction risk. 

<!-- I edited the CRS part to try to make it more accurate / relevant to the above paragraph and the NES. Still definitely want to edit in the future.-->

Previous research has shown that habitat area and fragmentation are directly related to extinction risk, with smaller habitat and more fragmentation each increasing a species’ vulnerability to stochastic effects. The amount of environmental variation a population undergoes is highly dependent on area of habitat. Because most environmental stressors are localized, a population with a large area of habitat benefits from the averaging effect of environmental effects that are not over the entire range, while populations with a small habitat are at a much higher risk of extinction because environmental changes are likely to affect the entire population [@lacyConsideringThreatsViability2000]. Species with small habitat area are also more likely to be affected by demographic stochasticity, including a sex ratio imbalance, inbreeding, and loss of genetic diversity. These demographic variations combined with a small habitat area lead to an impaired potential for local adaptation [@CITE]. Habitat fragmentation increases the risk of extinction in part due to its association with loss of habitat area [@crooksQuantificationHabitatFragmentation2017; @reedExtinctionRiskFragmented2004a]. In addition, fragmented habitats have a greater relative amount of edge, bringing concomitant edge effects like higher temperatures and easier access for poachers [@ewers_fragmentation_2013;pfeifer_creation_2017]. The isolation of fragmented habitat can also make it difficult for species to disperse elsewhere [@crooks_global_2011;haddad_habitat_2015]. Many species in the wild can only maintain a self-sustaining population if ongoing species-specific management interventions are implemented. These species are referred to as "Conservation Reliant Species" (CRS) in conservation literature [@scott_conservation-reliant_2010; @goble_conservation-reliant_2012; @scott_recovery_2005]. Species that have too little habitat to the extent that they are extremely vulnerable to demographic and environmental stochastic effects, and the effects of habitat fragmentation. Due to their vulnerability and low area of habitat, these species would be unable to maintain a viable population without conservation intervention such as habitat restoration or translocation. Furthermore, regardless of the other interventions we take, including captive breeding, habitat protection, invasive species removal and more, species with too little area of habitat cannot move beyond conservation reliance without increasing the amount of available habitat. 

<!-- I cut a lot of the AOO/EOO jargon to make it shorter (below). If you now think it is too succinct let me know and I can try to add more details back in. These two original paragraphs were what I probably made the most edits to today. -->
