...
The number of no exit species within each realm is calculated, in whcih a realm contains a no exit species if that species is listed solely in that realm or cross-listed in the realm.
