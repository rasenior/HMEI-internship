...
```{r fig-1, fig.cap = "Class and AOH of NES. The total number of threatened species classified as 'No Exit Species' (NES), within each class and AOH threshold met."}
nes <- nes_df %>% 
