...
* S.R. = High Meadows Environment Institute internship
* R.A.S. = High Meadows Foundation

# Metadata

* Number of words from Abstract through Literature Cited (maximum number of words for a contributed paper is 8000):
* Number of manuscript pages (Cover Page through Literature Cited):	
* Number of tables (use 0 for none). The number of tables plus figures (i.e., supporting elements) should not exceed 1 for every 4 manuscript pages:
* Total number of figures (use 0 for none). The number of tables plus figures (i.e., supporting elements) should not exceed 1 for every 4 manuscript pages:
* "I have supplied a separate cover page that includes acknowledgments. The manuscript, Supporting Information, and Additional Files for Review but Not for Publication do not contain text through which authors could be identified."
